        ...
        <center>
            ...
            <tr style="margin-top:1cm;">
                <div class="form-group" >
                  <th><label for="customerid"> <h3> CustomerId &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h3></label></th>
                  <td><input style=" border-radius:8px; background-color: white; color: red; border: 1px solid #ff0000;" type="number" name = "customerid" class="form-control" id="customerid" aria-describedby="emailHelp" placeholder="Enter CustomerId"></td>
             </div>
            <tr style="margin-top:1cm;"> 
                <div class="form-group" >
